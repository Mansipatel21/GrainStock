            ...
            <div class="container-fluid">
                <div class="row clearfix" id="trying">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            <div class="header">
                                <input type="hidden" id="hdnReport" value="Outward Report" />
                                            ...
                                            <table class="table table-bordered table-striped table-hover js-exportable dataTable">
                                                ...
                                                <tbody>
                                                    ...
                                                    if (isset($_POST['btnSubmit'])) {
                                                        ...
                                                        $Select_Product = "select buy.stock, buy.unit, buy.buyprice, buy.createddate, pro.productname from inwardproduct buy inner join 
...
//                                                    var_dump($result);
                                                        ...
                                                        $DateTrim = date('Y-m-d');
                                                        $Select_Product = "select buy.stock, buy.unit, 
